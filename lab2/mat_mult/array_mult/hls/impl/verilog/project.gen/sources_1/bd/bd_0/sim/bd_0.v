...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 in_a " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME in_a, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 100000000.0, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [15:0]in_a_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 in_a " *) input [1:0]in_a_tkeep;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 in_a " *) input [1:0]in_a_tstrb;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 in_a " *) input in_a_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.INTERRUPT INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.INTERRUPT, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) output interrupt;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 result " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME result, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 100000000.0, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [15:0]result_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 result " *) output [1:0]result_tkeep;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 result " *) output [1:0]result_tstrb;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi_DATA_IN_B " *) input [6:0]s_axi_DATA_IN_B_awaddr;
  ...
  wire [15:0]hls_inst_result_TDATA;
  wire [1:0]hls_inst_result_TKEEP;
  wire [0:0]hls_inst_result_TLAST;
  wire hls_inst_result_TREADY;
  wire [1:0]hls_inst_result_TSTRB;
  wire hls_inst_result_TVALID;
  wire [15:0]in_a_0_1_TDATA;
  wire [1:0]in_a_0_1_TKEEP;
  wire [0:0]in_a_0_1_TLAST;
  wire in_a_0_1_TREADY;
  wire [1:0]in_a_0_1_TSTRB;
  ...
  wire [6:0]s_axi_DATA_IN_B_0_1_ARADDR;
  wire s_axi_DATA_IN_B_0_1_ARREADY;
  wire s_axi_DATA_IN_B_0_1_ARVALID;
  wire [6:0]s_axi_DATA_IN_B_0_1_AWADDR;
  ...
  assign in_a_0_1_TDATA = in_a_tdata[15:0];
  assign in_a_0_1_TKEEP = in_a_tkeep[1:0];
  assign in_a_0_1_TLAST = in_a_tlast[0];
  assign in_a_0_1_TSTRB = in_a_tstrb[1:0];
  assign in_a_0_1_TVALID = in_a_tvalid;
  assign in_a_tready = in_a_0_1_TREADY;
  assign interrupt = hls_inst_interrupt;
  assign result_tdata[15:0] = hls_inst_result_TDATA;
  assign result_tkeep[1:0] = hls_inst_result_TKEEP;
  assign result_tlast[0] = hls_inst_result_TLAST;
  assign result_tstrb[1:0] = hls_inst_result_TSTRB;
  ...
  assign s_axi_DATA_IN_B_0_1_ARADDR = s_axi_DATA_IN_B_araddr[6:0];
  assign s_axi_DATA_IN_B_0_1_ARVALID = s_axi_DATA_IN_B_arvalid;
  assign s_axi_DATA_IN_B_0_1_AWADDR = s_axi_DATA_IN_B_awaddr[6:0];
