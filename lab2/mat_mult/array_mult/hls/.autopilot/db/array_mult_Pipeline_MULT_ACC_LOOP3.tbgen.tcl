set moduleName array_mult_Pipeline_MULT_ACC_LOOP3
set isTopModule 0
...
set C_modelName {array_mult_Pipeline_MULT_ACC_LOOP3}
...
set C_modelArgList {
	{ or_ln36_1 int 5 regular  }
	{ in_a_store_data int 16 regular {array 25 { 1 3 } 1 1 }  }
	{ in_b int 16 regular {array 25 { 1 } 1 1 }  }
	{ mult_acc_data_6_out int 16 regular {pointer 1}  }
}
set hasAXIMCache 0
set hasAXIML2Cache 0
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "or_ln36_1", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mult_acc_data_6_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ or_ln36_1 sc_in sc_lv 5 signal 0 } 
	...
	{ mult_acc_data_6_out sc_out sc_lv 16 signal 3 } 
	{ mult_acc_data_6_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "or_ln36_1", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "or_ln36_1", "role": "default" }} , 
 	...
 	{ "name": "mult_acc_data_6_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "mult_acc_data_6_out", "role": "default" }} , 
 	{ "name": "mult_acc_data_6_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "mult_acc_data_6_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_16ns_16_4_1_U25", "Parent" : "0"},
...
set Spec2ImplPortList { 
	or_ln36_1 { ap_none {  { or_ln36_1 in_data 0 5 } } }
	...
	mult_acc_data_6_out { ap_vld {  { mult_acc_data_6_out out_data 1 16 }  { mult_acc_data_6_out_ap_vld out_vld 1 1 } } }
}
