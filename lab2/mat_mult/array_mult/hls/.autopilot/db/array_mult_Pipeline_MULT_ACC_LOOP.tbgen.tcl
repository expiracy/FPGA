set moduleName array_mult_Pipeline_MULT_ACC_LOOP
set isTopModule 0
...
set C_modelName {array_mult_Pipeline_MULT_ACC_LOOP}
...
set C_modelArgList {
	...
	{ mult_acc_data_out int 16 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "j", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mult_acc_data_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ mult_acc_data_out sc_out sc_lv 16 signal 3 } 
	{ mult_acc_data_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mult_acc_data_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "mult_acc_data_out", "role": "default" }} , 
 	{ "name": "mult_acc_data_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "mult_acc_data_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_16ns_16_4_1_U9", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	mult_acc_data_out { ap_vld {  { mult_acc_data_out out_data 1 16 }  { mult_acc_data_out_ap_vld out_vld 1 1 } } }
}
